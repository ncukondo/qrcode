...
import Tabpager from 'Tabpager.svelete';
...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-8255eb63.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$3, 24, 4, 597);
			attr_dev(input0, "type", "radio");
			attr_dev(input0, "name", "test");
			input0.value = "text1";
			add_location(input0, file$3, 27, 6, 687);
			add_location(label0, file$3, 26, 4, 673);
			attr_dev(input1, "type", "radio");
			attr_dev(input1, "name", "test");
			input1.value = "text2";
			add_location(input1, file$3, 31, 6, 780);
			add_location(label1, file$3, 30, 4, 766);
			attr_dev(input2, "type", "radio");
			attr_dev(input2, "name", "test");
			input2.value = "text3";
			add_location(input2, file$3, 35, 6, 873);
			add_location(label2, file$3, 34, 4, 859);
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 40, 6, 990);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 41, 6, 1037);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 42, 6, 1092);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 39, 4, 953);
			attr_dev(div0, "class", "contents m-5 w-10/12 sm:w-64");
			add_location(div0, file$3, 22, 2, 549);
			attr_dev(div1, "class", "flex justify-center");
			add_location(div1, file$3, 21, 0, 513);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-4172d64a.js.map
