...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 62, 6, 1727);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, file, 67, 6, 1849);
			...
			add_location(a1, file, 73, 6, 2002);
			add_location(div, file, 66, 4, 1837);
		},
		m: function mount(target, anchor) {
...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-d979be2a.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			input0.value = "text1";
			add_location(input0, file$3, 17, 6, 458);
			add_location(label0, file$3, 16, 4, 444);
			attr_dev(input1, "type", "radio");
			attr_dev(input1, "name", "test");
			input1.value = "text2";
			add_location(input1, file$3, 21, 6, 551);
			add_location(label1, file$3, 20, 4, 537);
			attr_dev(input2, "type", "radio");
			attr_dev(input2, "name", "test");
			input2.value = "text3";
			add_location(input2, file$3, 25, 6, 644);
			add_location(label2, file$3, 24, 4, 630);
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 30, 6, 761);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 31, 6, 808);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 32, 6, 863);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 29, 4, 724);
			attr_dev(div0, "class", "contents m-5 w-10/12 sm:w-64");
			add_location(div0, file$3, 14, 2, 396);
			attr_dev(div1, "class", "flex justify-center");
			add_location(div1, file$3, 13, 0, 360);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-1d11933d.js.map
