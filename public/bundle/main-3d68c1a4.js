...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-d6d07433.js');
...
const params$ = derived(querystring, $querystring => {
  ...
  return [...urlParams].reduce((stack, [key, value]) => {
    stack[key] = value;
    return stack;
  }, {})
});
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a1, "href", "/camera?size=600");
			add_location(a1, file$3, 15, 2, 436);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 16, 2, 496);
...
//# sourceMappingURL=main-3d68c1a4.js.map
