...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-1a12abcc.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$3, 16, 4, 444);
			attr_dev(input0, "type", "radio");
			attr_dev(input0, "name", "test");
			input0.value = "text1";
			add_location(input0, file$3, 18, 6, 478);
			add_location(label0, file$3, 17, 4, 464);
			attr_dev(input1, "type", "radio");
			attr_dev(input1, "name", "test");
			input1.value = "text2";
			add_location(input1, file$3, 22, 6, 571);
			add_location(label1, file$3, 21, 4, 557);
			attr_dev(input2, "type", "radio");
			attr_dev(input2, "name", "test");
			input2.value = "text3";
			add_location(input2, file$3, 26, 6, 664);
			add_location(label2, file$3, 25, 4, 650);
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 31, 6, 781);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 32, 6, 828);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 33, 6, 883);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 30, 4, 744);
...
//# sourceMappingURL=main-f8a628f8.js.map
