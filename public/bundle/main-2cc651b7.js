...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-b91e722a.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 14, 2, 392);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 15, 2, 435);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 16, 2, 486);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 13, 0, 359);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self) {
	...
	params$.subsrive(params => console.log(params));
...
//# sourceMappingURL=main-2cc651b7.js.map
