...
async function startAnalyzing(video) {
  ...
  const jsQRModule = await import('./jsQR-ba507b71.js');
...
function startCapture() {
  startReading(navigator.mediaDevices.getDisplayMedia);
}
...
const file = "src/components/QRCapture.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			if_block.c();
			add_location(b_message, file, 10, 10, 235);
			attr_dev(div0, "class", "column");
			add_location(div0, file, 9, 8, 204);
			attr_dev(div1, "class", "columns");
			add_location(div1, file, 8, 6, 174);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 7, 4, 144);
			add_location(section0, file, 6, 2, 130);
			attr_dev(button, "class", "button");
			add_location(button, file, 20, 12, 523);
			attr_dev(div3, "class", "column");
			add_location(div3, file, 19, 10, 490);
			attr_dev(div4, "class", "columns");
			add_location(div4, file, 18, 8, 458);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 17, 6, 426);
			attr_dev(div6, "class", "hero-body hero-body-hp-main");
			add_location(div6, file, 16, 4, 378);
			attr_dev(section1, "class", "hero is-medium has-text-centered");
			add_location(section1, file, 15, 2, 323);
			add_location(div7, file, 4, 0, 99);
		},
...
function create_fragment$1(ctx) {
	let main;
	let current;
	const qrcapture = new QRCapture({ $$inline: true });

	const block = {
		c: function create() {
			main = element("main");
			create_component(qrcapture.$$.fragment);
		...
		m: function mount(target, anchor) {
			...
			mount_component(qrcapture, main, null);
			current = true;
		},
		p: noop,
		i: function intro(local) {
			if (current) return;
			transition_in(qrcapture.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(qrcapture.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(main);
			destroy_component(qrcapture);
		}
	};
...
//# sourceMappingURL=main-5e5989e5.js.map
