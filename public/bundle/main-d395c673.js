...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-492b5948.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			input0.value = "text1";
			add_location(input0, file$3, 14, 2, 370);
			add_location(label0, file$3, 13, 0, 360);
			attr_dev(input1, "type", "radio");
			attr_dev(input1, "name", "test");
			input1.value = "text2";
			add_location(input1, file$3, 18, 2, 447);
			add_location(label1, file$3, 17, 0, 437);
			attr_dev(input2, "type", "radio");
			attr_dev(input2, "name", "test");
			input2.value = "text3";
			add_location(input2, file$3, 22, 2, 524);
			add_location(label2, file$3, 21, 0, 514);
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 27, 2, 625);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 28, 2, 668);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 29, 2, 719);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 26, 0, 592);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-d395c673.js.map
