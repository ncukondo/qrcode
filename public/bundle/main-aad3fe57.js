...
async function startAnalyzing(video) {
  ...
  const jsQR = await import('./jsQR-aa883f08.js');
  console.log("loaded library..." + jsQR);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			div5 = element("div");
			video = element("video");
			add_location(b_message, file, 18, 10, 327);
			attr_dev(div0, "class", "column");
			add_location(div0, file, 17, 8, 296);
			attr_dev(div1, "class", "columns");
			add_location(div1, file, 16, 6, 266);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 15, 4, 236);
			add_location(section0, file, 14, 2, 222);
			attr_dev(button, "class", "button");
			add_location(button, file, 28, 12, 615);
			attr_dev(div3, "class", "column");
			add_location(div3, file, 27, 10, 582);
			attr_dev(div4, "class", "columns");
			add_location(div4, file, 26, 8, 550);
			attr_dev(video, "width", /*width*/ ctx[2]);
			attr_dev(video, "height", /*height*/ ctx[3]);
			video.autoplay = true;
			add_location(video, file, 35, 12, 857);
			attr_dev(div5, "class", "column");
			add_location(div5, file, 34, 10, 824);
			attr_dev(div6, "class", "columns");
			add_location(div6, file, 33, 8, 792);
			attr_dev(div7, "class", "container");
			add_location(div7, file, 25, 6, 518);
			attr_dev(div8, "class", "hero-body hero-body-hp-main");
			add_location(div8, file, 24, 4, 470);
			attr_dev(section1, "class", "hero is-medium has-text-centered");
			add_location(section1, file, 23, 2, 415);
			add_location(div9, file, 12, 0, 192);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const click_handler = () => toggleReading();
...
//# sourceMappingURL=main-aad3fe57.js.map
