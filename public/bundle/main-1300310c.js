...
async function startAnalyzing(video) {
  ...
  const interval = setInterval(async () => {
    ...
    jsQRModule = jsQRModule || await import('./jsQR-3559425c.js');
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a0, "href", "/");
			add_location(a0, file$3, 19, 2, 409);
			attr_dev(a1, "href", "/camera");
			add_location(a1, file$3, 20, 2, 452);
			attr_dev(a2, "href", "/capture");
			add_location(a2, file$3, 21, 2, 503);
			attr_dev(main, "class", "overflow-hidden");
			add_location(main, file$3, 18, 0, 376);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
//# sourceMappingURL=main-1300310c.js.map
